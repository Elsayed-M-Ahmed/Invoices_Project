			...
			<div class="card mg-b-20">
				<div class="card-header pb-0">
					<div class="d-flex justify-content-between">
						<a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">Add Department</a>
								...
								<tr>
									...
									<td>
										...
										<a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
											data-id="{{ $department->id }}" data-department_name="{{ $department->department_name }}"
											data-description="{{ $department->description }}" data-toggle="modal" href="#exampleModal2"
											title="edit"><i class="las la-pen"></i></a>

										<a class="modal-effect btn btn-sm btn-danger" data-effect="effect-scale"
											data-id="{{ $department->id }}" data-department_name="{{ $department->department_name }}" data-toggle="modal"
					   ...
					   <div class="modal-body">
						   ...
						   <form action="/departments/update" method="post" autocomplete="off">
							   ...
							   <div class="form-group">
								   ...
								   <input class="form-control" name="section_name" id="department_name" type="text">
							   </div>
							   <div class="form-group">
